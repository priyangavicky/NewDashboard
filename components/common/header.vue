            ...
            <div class="header-content-right">
                ...
                <div class="header-element cart-dropdown">
                    ...
                    <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                        ...
                        <div v-if="cartList.length" class="p-3 empty-header-item border-top">
                            <div class="d-grid">
                                <NuxtLink to="/" class="btn btn-primary">Proceed to checkout</NuxtLink>
                            </div>
                        </div>
                        <div v-if="!cartList.length" class="p-5 empty-item">
                            <div class="text-center">
                                ...
                                <NuxtLink to="/" class="btn btn-primary btn-wave btn-sm m-1" data-abc="true">continue shopping <i class="bi bi-arrow-right ms-1"></i></NuxtLink>
                            </div>
                        </div>
                    </div>
                ...
                <div class="header-element notifications-dropdown">
                    ...
                    <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                        ...
                        <ul v-if="notificationList.length" class="list-unstyled mb-0" id="header-notification-scroll">
                            <li v-for="(item, key) in notificationList" :key=key class="dropdown-item">
                                <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <p class="mb-0 fw-semibold"><NuxtLink to="/">{{item.title}}</NuxtLink></p>
                        ...
                        <div v-if="notificationList.length" class="p-3 empty-header-item1 border-top">
                            <div class="d-grid">
                                <NuxtLink to="/" class="btn btn-primary">View All</NuxtLink>
                            </div>
                        </div>
                ...
                <v-menu class="header-element" transition="slide-y-transition">
                    ...
                    <v-list class="main-header-dropdown pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                        ...
                        <v-list-item><NuxtLink to="/" class="dropdown-item d-flex"><i class="ti ti-inbox fs-18 me-2 op-7"></i>Inbox <span class="badge bg-success-transparent ms-auto">25</span></NuxtLink></v-list-item>
                        <v-list-item><NuxtLink to="/" class="dropdown-item d-flex border-block-end" ><i class="ti ti-clipboard-check fs-18 me-2 op-7"></i>Task Manager</NuxtLink></v-list-item>
                        <v-list-item><NuxtLink to="/" class="dropdown-item d-flex"><i class="ti ti-adjustments-horizontal fs-18 me-2 op-7"></i>Settings</NuxtLink></v-list-item>
